...
// Use the getMovies() function to get the list of movie objects, and send it with the ejs template index.ejs
// For /movie/:movieId, use the route params to find the corresponding movie object from the list of movies, then send it with the ejs template movie.ejs
// Follow the comments in the ejs files to display dynamic data on the webpage

// This challenge is complete when:

// A user can browse all movies in the list
// A user can click a movie to visit its detailed page
// A user can go back to the movie list from a detailed page by clicking a 'Back' button
...
// let keys = Object.keys(moviesArray[0]).forEach(function(elem) {
//   console.log(elem.toLocaleUpperCase());
// });

// let values = Object.keys(moviesArray[0]).forEach(function(elem) {
//   console.log(moviesArray[2][elem]);
// });
...
app.get('/movie/:movieId', (req, res) => {
  ...
  -------------------------------------------------- */
  let blah = req.params.movieId
  for (let i = 0; i < moviesArray.length; ++i) {
    if (blah === moviesArray[i].id) {
      res.render("pages/movie", { movies: moviesArray[i] })
    }
  }
})
...
// Object.keys(moviesArray[0]).forEach(function(elem) {
//   console.log(elem.toLocaleUpperCase());
// });
